...
declare module Jolt {
    ...
    class Vec3 {
        ...
        static sAxisY(): Vec3;
        static sAxisZ(): Vec3;
        static sReplicate(inValue: number): Vec3;
    ...
    class Quat {
        ...
        static sRotation(inRotation: Vec3, inAngle: number): Quat;
    ...
    class Mat44 {
        ...
        static sRotationX(inX: number): Mat44;
        static sRotationY(inY: number): Mat44;
        static sRotationZ(inZ: number): Mat44;
        ...
        static sScale(inScale: number): Mat44;
        static sPerspective(inFovY: number, inAspect: number, inNear: number, inFar: number): Mat44;
        GetAxisX(): Vec3;
        GetAxisY(): Vec3;
        GetAxisZ(): Vec3;
        GetRotation(): Mat44;
    ...
    class StaticCompoundShape extends Shape {
    }
    ...
    class ObjectLayerPairFilterMask extends ObjectLayerPairFilter {
        constructor();
        static sGetObjectLayer(inGroup: number, inMask: number): number;
        static sGetGroup(inObjectLayer: number): number;
        static sGetMask(inObjectLayer: number): number;
    }
    class JoltSettings {
        constructor();
